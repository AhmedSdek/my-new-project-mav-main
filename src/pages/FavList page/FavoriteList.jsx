...
function FavoriteList() {
  ...
  if (value) {
    ...
    return (
      <Stack sx={{ minHeight: "calc(100vh - 100px)", paddingTop: "70px" }}>
        <Container>
          <Stack>
            <Stack>
            ...
            {localFilter.length > 0 ? (
              ...
              >
                {value.docs
                  .filter((itm) => localFilter.includes(itm.data().id))
                  .map((item, index) => {
                    return (
                      <Stack
                        sx={{
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <Checkbox
                                checked={
                                  localStorage.getItem(item.data().id) ===
                                  "true"
                                    ? true
                                    : false
                                }
                              ...
                              />
                              <Typography>{item.data().like}</Typography>
                            </Stack>
                            <ContactUsIcon />
                          </Stack>
                        </Card>
