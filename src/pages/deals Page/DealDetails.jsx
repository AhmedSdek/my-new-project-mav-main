            ...
            >
              <Stack>
                <img
                  ...
                  src={deal.devIcon}
                  alt={deal.developer.devName[lang]}
                />
              </Stack>
              <Stack sx={{ width: "100%", gap: 2 }}>
                ...
                >
                  <Stack sx={{ gap: 1 }}>
                    ...
                    >
                      {`${deal.Type[lang]} in ${deal.compoundName[lang]}`}
                    </Typography>
                    <Typography
                      variant="caption"
                      sx={{
                ...
                >
                  ...
                  >
                    {`${Intl.NumberFormat("en-US").format(deal.price)} ${
                      deal.monyType.en === "dollar"
                        ? lang === "ar"
                          ? "دولار"
                          : "$"
                        : lang === "ar"
                  ...
                  <TableHead>
                    <TableRow>
                      <StyledTableCell
                        ...
                        colSpan={2}
                      >{`About ${deal.Type[lang]}`}</StyledTableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    ...
                    {deal.landArea != null && deal.landArea !== "" && (
                      <StyledTableRow>
                        <StyledTableCell component="th" scope="row">
                          Land Area
                        </StyledTableCell>
                    ...
                    <StyledTableRow>
                      ...
                      <StyledTableCell align="left">{`${deal.Area} m²`}</StyledTableCell>
                    </StyledTableRow>

                    {deal.gardenArea != null && deal.gardenArea !== "" && (
                      <StyledTableRow>
                        <StyledTableCell component="th" scope="row">
                          Garden Area
                        </StyledTableCell>
            ...
            {deal.Sale.en === "Resale" && (
              ...
              >
                ...
                >
                  ...
                  <Stack sx={{ width: "100%" }}>
                    {deal.downPayment != null && deal.downPayment !== "" && (
                      <Stack
                        sx={{
                          flexDirection: "row",
                      ...
                      >
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            <Typography>{`${deal.downPayment} EGP`}</Typography>
                          </Stack>
                        </Stack>
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            <Typography>{deal.remaining} EGP</Typography>
                            <Typography
                              variant="caption"
                              sx={{ marginLeft: "10px" }}
                            >
                              Over {deal.month} Month
                            </Typography>
                          </Stack>
                        </Stack>
                      </Stack>
